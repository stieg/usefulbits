...
(yas-define-snippets 'prog-mode
                     '(("x" "`comment-start`XXX: $0`comment-end`" "xxx" nil nil nil "/home/stieg/.emacs.d/elpa/yasnippet-snippets-20200606.1149/snippets/prog-mode/xxx" nil nil)
                       ("t" "`comment-start`TODO: $0`comment-end`" "todo" nil nil nil "/home/stieg/.emacs.d/elpa/yasnippet-snippets-20200606.1149/snippets/prog-mode/todo" nil nil)
                       ("fi" "`comment-start`FIXME: $0`comment-end`" "fixme"
                        (not
                         (eq major-mode 'sh-mode))
                        nil nil "/home/stieg/.emacs.d/elpa/yasnippet-snippets-20200606.1149/snippets/prog-mode/fixme" nil nil)
                       ("col" "`(yas-trimmed-comment-start)` ${1:comment} ${1:$(let* ((start (yas-trimmed-comment-start))\n                                                       (lastcom (aref start (1- (length start))))\n                                                       (end (yas-trimmed-comment-end))\n                                                       (endpadlen (- 79 (+ (current-column) (length end)))))\n                                              (concat (make-string (max endpadlen 0) lastcom)\n                                                      end))}$0" "commentline" nil nil nil "/home/stieg/.emacs.d/elpa/yasnippet-snippets-20200606.1149/snippets/prog-mode/commentline" nil nil)
                       ("cob" "${1:$(let* ((col (current-column))\n           (str \"\")\n           (lastcom (substring (yas-trimmed-comment-start) -1))\n           (start (yas-trimmed-comment-start))\n           (end (yas-trimmed-comment-end))\n           (over (- (+ (string-width yas-text) (length start) (length end) col) 77)))\n         (while (< (length str) (+ (- 79 (length start) (length end) col) (if (> over 0) over 0)))\n                (setq str (concat str lastcom)))\n       (concat start str end))}\n${1:$(let* ((col (current-column))\n           (str \"\")\n           (start (yas-trimmed-comment-start))\n           (end (yas-trimmed-comment-end)))\n         (while (< (length str) (ffloor (/ (- 78.0 (+ col (length start) (string-width yas-text) (length end))) 2.0)))\n                (setq str (concat str \" \")))\n        (concat start str))} ${1:comment} ${1:$(let* ((col (current-column))\n                                                     (str \"\")\n                                                     (start (yas-trimmed-comment-start))\n                                                     (end (yas-trimmed-comment-end)))\n                                                   (while (< (length str) (- 79.0 (if (eq (mod (string-width yas-text) 2) 1) (- col 1) col) (length end)))\n                                                          (setq str (concat str \" \")))\n                                                 (concat str end))}\n${1:$(let* ((col (current-column))\n           (str \"\")\n           (lastcom (substring (yas-trimmed-comment-start) -1))\n           (start (yas-trimmed-comment-start))\n           (end (yas-trimmed-comment-end))\n           (over (- (+ (string-width yas-text) (length start) (length end) col) 77)))\n         (while (< (length str) (+ (- 79 (length start) (length end) col) (if (> over 0) over 0)))\n                (setq str (concat str lastcom)))\n       (concat start str end))}$0" "commentblock" nil nil nil "/home/stieg/.emacs.d/elpa/yasnippet-snippets-20200606.1149/snippets/prog-mode/commentblock" nil nil)
                       ("co" "`(yas-trimmed-comment-start)` ${1:comment}`(unless (eq (length comment-end) 0) (concat \" \" (yas-trimmed-comment-end)))`$0" "comment" nil nil nil "/home/stieg/.emacs.d/elpa/yasnippet-snippets-20200606.1149/snippets/prog-mode/comment" nil nil)))
